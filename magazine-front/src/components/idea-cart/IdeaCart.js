...
export default class IdeaCart extends Component {
    render() {
        return ( <
            ...
            <
            div cෆෆlassName = "top-spacer" > < /div> ‍ <
            div className = "page-container" >
            <
            div className = "page-title" > { this.props.pageTitle } < /div>  <
            div className = "idea-cart-container" > { /* section 1 */ } <
            ...
            for process improvement of, < br / > < br / >
            <
            ul >
            <
            li > HR related < /li> <
            ...
            li > We would like to know
            if you have any compaints as well. < /li> < /
            ul >
